      ...
      <div class="container-fluid p-2">
        <table class="table">
          ...
          <tbody>
            ...
            <div id="left"><a href="homeOrientacion.php" class="btn btn-secondary btn-block">Regresar</a></div><br><br>
          </h5>
      ...
      <ul class="pagination pg-dark justify-content-center pb-5 pt-5 mb-0" style="float: none;">
        <li class="page-item">
          ...
          if ($_REQUEST["nume"] == "1") {
            ...
            if ($pagina > 1)
              $ant = $_REQUEST["nume"] - 1;
            echo "<a class='page-link' aria-label='Previous' href='datosBDView_Orientacion.php?nume=1'><span aria-hidden='true'>&laquo;</span><span class='sr-only'>Previous</span></a>";
            echo "<li class='page-item '><a class='page-link' href='datosBDView_Orientacion.php?nume=" . ($pagina - 1) . "' >" . $ant . "</a></li>";
          }
          ...
          if ($pagina < $paginas && $paginas > 1)
            echo "<li class='page-item'><a class='page-link' href='datosBDView_Orientacion.php?nume=" . ($pagina + 1) . "'>" . $sigui . "</a></li>";
          if ($pagina < $paginas && $paginas > 1)
            echo "
              <li class='page-item'><a class='page-link' aria-label='Next' href='datosBDView_Orientacion.php?nume=" . ceil($ultima) . "'><span aria-hidden='true'>&raquo;</span><span class='sr-only'>Next</span></a>
              </li>";
          ?>
      </ul>
    </div>
